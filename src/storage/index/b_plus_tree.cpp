...
/*****************************************************************************
 * SEARCH Sequentially(self-defined)
 *****************************************************************************/
INDEX_TEMPLATE_ARGUMENTS
auto BPLUSTREE_TYPE::GetValueSeq(const KeyType &key, std::vector<ValueType> *result, Transaction *txn) -> bool {
...
INDEX_TEMPLATE_ARGUMENTS
auto BPLUSTREE_TYPE::InsertSeq(const KeyType &key, const ValueType &value, Transaction *txn) -> bool {
  // Declaration of context instance.
  Context ctx;
  (void)ctx;
...
/*****************************************************************************
 * REMOVE Sequentially(self-defined)
 *****************************************************************************/
INDEX_TEMPLATE_ARGUMENTS
void BPLUSTREE_TYPE::RemoveSeq(const KeyType &key, Transaction *txn) {
  // Declaration of context instance.
  Context ctx;
  (void)ctx;
  BasicPageGuard header_page = bpm_->FetchPageBasic(header_page_id_);
