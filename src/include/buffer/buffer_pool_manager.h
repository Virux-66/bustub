...
class BufferPoolManager {
 ...
 private:
  ...
  /** This latch protects shared data structures. We recommend updating this comment to describe what it protects. It
   * protects all member of buffer pool(big lock).*/
  std::mutex latch_;
